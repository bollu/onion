...
class TokenLineScroller
{
    ...
    // Lays out one paragraph into lines. Injected rather than computed here so the
    // scroller stays independent of fonts and screen geometry; the view supplies a
    // closure over its current font, column width and justification settings.
