...
TEST(STR_UTILS, has_token)
{
    EXPECT_TRUE(has_token("nav", "nav"));
    EXPECT_TRUE(has_token("nav scripted", "nav"));
    EXPECT_TRUE(has_token("scripted nav", "nav"));
    EXPECT_TRUE(has_token("  svg   cover-image  ", "cover-image"));

    EXPECT_FALSE(has_token("not-cover-image", "cover-image"));
    EXPECT_FALSE(has_token("navigation", "nav"));
    EXPECT_FALSE(has_token("", "nav"));
    EXPECT_FALSE(has_token("nav", ""));
}
